<?php
    ...
    define( 'PAGE_SETTINGS', 'snrg-page-settings' );
    define( 'SETTINGS_DATA', 'snrg_settings' );
    define( 'SETTING_INTRODUCTION_PAGE', 'introduction_page' );
    define( 'SETTING_BIOGRAPHY_PAGE', 'biography_page' );
    ...
    define( 'PROGRAM_POST_TYPE', 'snrg_must_see' );
