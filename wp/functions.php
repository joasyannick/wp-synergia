<?php
    ...
    class add_settings {
        ...
        private $fields = [
            [
                'id' => SETTING_INTRODUCTION_PAGE,
                'label' => 'Introduction Page',
            ],
            [
                'id' => SETTING_BIOGRAPHY_PAGE,
                'label' => 'Biography Page',
            ],
            [
                'id' => SETTING_CONTACT_PAGE,
                'label' => 'Contact Page',
            ],
            [
                'id' => SETTING_HELIKIA_PAGE,
                'label' => 'Helikia Page',
            ],
            [
        ...
        function add_settings_page() {
            add_menu_page( 'WP Synergia', 'WP Synergia', $this->capability, SETTINGS, [ $this, 'render_settings_page' ], 'dashicons-menu' );
        }
